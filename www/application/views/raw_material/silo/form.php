...
<div class="row align-items-center mb-3">
    ...
    <div class="col-12 col-lg-6">
        <div class="d-flex justify-content-lg-end">
            <a title="Voltar" href="<?= base_url('materia_prima/cadastro/silo/lst') ?>" class="btn btn-sm btn-dark">
...
<div class="row">
    <div class="col-12">
        <form id="j_app_send_requisition" method="post" action="<?= base_url('materia_prima/cadastro/silo/frm/' . $silo['id']) ?>">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" value="<?= $silo['id'] ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-10">
                            <div class="form-group">
                                ...
                                <input type="text" name="description" id="description" class="form-control form-control-sm j_app_mask_uppercase" value="<?= $silo['description'] ?>">
                            </div>
                        </div>
                    </div>
                </div>

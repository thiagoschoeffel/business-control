...
<div class="row align-items-center mb-3">
    ...
    <div class="col-12 col-lg-6">
        <div class="d-flex justify-content-lg-end">
            <a title="Cadastrar" href="<?= base_url('materia_prima/movimento/apontamento/frm') ?>" class="btn btn-sm btn-dark">
                ...
                <table id="j_app_datatable_requisition" class="table table-striped" style="width:100%">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th>Matéria Prima</th>
                            <th>Quantidade (kg)</th>
                            <th>Quantidade Considerada (kg)</th>
                            <th>Silos</th>
                            <th>Operadores</th>
                            <th>Blocos (und)</th>
                            <th>Blocos (m³)</th>
                            <th>Blocos Virgem (kg)</th>
                            <th>Blocos Reciclado (kg)</th>
                            <th>Moldados (und)</th>
...
<script>
    $(document).ready(function () {
        $("#j_app_datatable_requisition").DataTable({
            ...
            ajax: {
                url: "<?= base_url('materia_prima/movimento/apontamento/lst') ?>",
                "dataSrc": "data",
                beforeSend: function () {
                    loaderOn();
                },
            ...
            "columns": [
                ...
                {"data": "quantity"},
                {"data": "quantity_considered"},
                {"data": "silos"},
                {"data": "operators"},
                {"data": "block_count"},
                {"data": "block_cubic_meters"},
                {"data": "block_virgin_weight"},
                {"data": "block_recycled_weight"},
                {"data": "molded_quantity"},
                {"data": "molded_refugee_quantity"},
                {"data": "molded_total_weight_considered"}
            ]
        });
    });
    ...
    $(document).on('click', '#j_app_send_delete', function (e) {
        ...
        var url = "<?= base_url('materia_prima/movimento/apontamento/dlt') ?>";
        var data = {
            "id": $('#id').val()
        };

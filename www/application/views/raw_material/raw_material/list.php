...
<div class="row align-items-center mb-3">
    ...
    <div class="col-12 col-lg-6">
        <div class="d-flex justify-content-lg-end">
            <a title="Cadastrar" href="<?= base_url('materia_prima/cadastro/materia_prima/frm') ?>" class="btn btn-sm btn-dark">
                ...
                <table id="j_app_datatable_requisition" class="table table-striped" style="width:100%">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th>Código</th>
                            <th>Descrição</th>
                            <th>Data Inicial Estoque</th>
                            <th>Quantidade Inicial Estoque (kg)</th>
                        </tr>
                    </thead>
                </table>
            </div>
...
<script>
    $(document).ready(function () {
        $("#j_app_datatable_requisition").DataTable({
            ...
            ajax: {
                url: "<?= base_url('materia_prima/cadastro/materia_prima/lst') ?>",
                "dataSrc": "data",
                beforeSend: function () {
                    loaderOn();
                },
            ...
            "columns": [
                ...
                {"data": "id"},
                {"data": "description"},
                {"data": "date_initial_inventory"},
                {"data": "quantity_initial_inventory"}
            ]
        });
    });
    ...
    $(document).on('click', '#j_app_send_delete', function (e) {
        ...
        var url = "<?= base_url('materia_prima/cadastro/materia_prima/dlt') ?>";
        var data = {
            "id": $('#id').val()
        };

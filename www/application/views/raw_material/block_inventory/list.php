...
<div class="row align-items-center mb-3">
    ...
    <div class="col-12 col-lg-6">
        <div class="d-flex justify-content-lg-end">
            <a title="Cadastrar" href="<?= base_url('materia_prima/movimento/inventario_bloco/frm') ?>" class="btn btn-sm btn-dark">
...
<script>
    $(document).ready(function () {
        $("#j_app_datatable_requisition").DataTable({
            ...
            ajax: {
                url: "<?= base_url('materia_prima/movimento/inventario_bloco/lst') ?>",
                "dataSrc": "data",
                beforeSend: function () {
                    loaderOn();
                },
    ...
    $(document).on('click', '#j_app_send_delete', function (e) {
        ...
        var url = "<?= base_url('materia_prima/movimento/inventario_bloco/dlt') ?>";
        var data = {
            "id": $('#id').val()
        };

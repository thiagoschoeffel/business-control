...
<div class="row align-items-center mb-3">
    ...
    <div class="col-12 col-lg-6">
        <div class="d-flex justify-content-lg-end">
            <a title="Cadastrar" href="<?= base_url('materia_prima/movimento/saida_moldado/frm') ?>" class="btn btn-sm btn-dark">
                ...
                <table id="j_app_datatable_requisition" class="table table-striped" style="width:100%">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th>Operadores Requisição</th>
                            <th>Operadores Retirada</th>
                        </tr>
                    </thead>
                </table>
            </div>
...
<script>
    $(document).ready(function () {
        $("#j_app_datatable_requisition").DataTable({
            ...
            ajax: {
                url: "<?= base_url('materia_prima/movimento/saida_moldado/lst') ?>",
                "dataSrc": "data",
                beforeSend: function () {
                    loaderOn();
                },
            ...
            "columns": [
                ...
                {"data": "delete"},
                {"data": "id"},
                {"data": "date_time_output"},
                {"data": "molded_type_description"},
                {"data": "quantity_output"},
                {"data": "fabrication_order"},
                {"data": "requisition_operators"},
                {"data": "output_operators"}
            ]
        });
    });
    ...
    $(document).on('click', '#j_app_send_delete', function (e) {
        ...
        var url = "<?= base_url('materia_prima/movimento/saida_moldado/dlt') ?>";
        var data = {
            "id": $('#id').val()
        };
